...
public class A3231JBLAKER {
    ...
    public static void main(String[] args)
        ...
        while (truefalse) {
            ...
            // Repeat as long as we have unprocessed input
            while (lineScan.hasNext()) {
                // if next item is an int, add to arraylist, else discard
                if (lineScan.hasNextInt()) {
                    values.add(lineScan.nextInt());
                    selectionsort(values);
                } else {
                    // deliberately not assigned, merely "digested"
                    lineScan.next();
                }
            }
        }
